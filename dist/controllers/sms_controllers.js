...
exports.SmsControllers = void 0;
const uuid_1 = require("uuid");
const lead_models_1 = __importDefault(require("../models/lead_models"));
const sms_models_1 = __importDefault(require("../models/sms_models"));
class SmsControllers {
    static AddSms(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const lead = yield sms_models_1.default.create({
                    sms: sms,
                });
                res.status(201).json({
                    requestId: (0, uuid_1.v4)(),
...
exports.SmsControllers = SmsControllers;
